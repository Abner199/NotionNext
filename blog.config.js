...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '50e49350d24d4fc9b4fedeea88ca54e2',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'abnerNext', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'abnerwei.cloudns.org', // 网站地址
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      url: 'https://music.163.com/song/media/outer/url?id=190233.mp3',
      cover:
            'https://p2.music.126.net/itLHKNG8Mb8Gt7sgVvagvg==/109951167222024810.jpg'
    },
    {
      name: '王都グランセル',
      artist: 'Falcom Sound Team jdk',
